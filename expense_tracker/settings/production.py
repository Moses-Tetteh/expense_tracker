...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@mosestetteh713.com')
SERVER_EMAIL = config('SERVER_EMAIL', default='server@expensetracker.com')
...
# Password validators - stricter for production
...
LOGGING['loggers']['expenses']['level'] = 'INFO'
